...
func main() {
	...
	//http.HandleFunc("/destinations", forum.RenderDestinationsPage)
	http.HandleFunc("/destinations", forum.CombinedHandler)

	http.HandleFunc("/like-region", forum.LikeRegionHandler)
